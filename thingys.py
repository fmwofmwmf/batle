...
inter = Main(10, 800, 450, s=20, att = {
                                    'dmg':{'contact':10, 'w1':100},
                                    'h':{'H':4500, 'MH':5000, 'R':-1, 'S':'BAR'}})

ob0 = lambda x,y: Ob(9, x, y, s=10, att={'h':{'H':200, 'MH':200, 'S':'TRANS'}, 'dmg':{'contact':10, 'b':
...
ob1 = lambda x,y: Ob(9, x, y, s=10, att={'h':{'H':200, 'MH':200, 'S':'TRANS'}, 'dmg':{'contact':10, 'b':
...
ob2 = lambda x,y: Ob(9, x, y, s=10, att={'h':{'H':200, 'MH':200, 'S':'TRANS'}, 'dmg':{'contact':10, 'b':
                                    lambda x,y,v,a=1: Shoot(20, x, y, v, att = {
                                    'dmg':{'P':5, 'contact':35},
                                    'age':{'max':60, 'a':1},
                                    'g':None, 'id':'', 
...
ob3 = lambda x,y: Ob(9, x, y, s=10, att={'h':{'H':200, 'MH':200, 'S':'TRANS'}, 'dmg':{'contact':10, 'b':
...
ob4 = lambda x,y: Ob(9, x, y, s=10, att={'h':{'H':200, 'MH':200, 'S':'TRANS'}, 'dmg':{'contact':10, 'b':
...
ob5 = lambda x,y: Ob(9, x, y, s=10, att={'h':{'H':200, 'MH':200, 'S':'TRANS'}, 'dmg':{'contact':10, 'b':
...
ob6 = lambda x,y: Ob(9, x, y, s=10, att={'h':{'H':200, 'MH':200, 'S':'TRANS'}, 'dmg':{'contact':10, 'c':0, 'CD':50}, 'g':o1, 'id':'ob6'})
